...
async function showSplash(){
  app.innerHTML=`<div class="splash-logo">LIMEN</div><div class="splash-tagline">Your micro-regulation companion</div>`;
  fadeIn(app);
...
// ---------------------
function showEntry(){
  app.innerHTML=`<div>Pause.</div><button id="continueBtn">Continue</button><div class="app-name">LIMEN</div>`;
  fadeIn(app);
...
function deliverIntervention(state){
  ...
  app.innerHTML=`
    ...
    <div class="timer-circle"><div id="timerFill" class="timer-fill"></div><div id="timerText">${duration}</div></div>
