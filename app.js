...
function showInstallHint(){
  ...
  hint.innerHTML=`<div style="position:fixed;bottom:16px;left:16px;right:16px;background:rgba(28,28,35,0.95);border:1px solid #2a2a33;border-radius:12px;padding:12px 14px;font-size:0.85rem;color:#ccc;display:flex;justify-content:space-between;align-items:center;z-index:9999;">
